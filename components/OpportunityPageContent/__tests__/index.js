...
describe('OpportunityPageContent', function() {
  it('validates on propTypes', function() {
    ...
    Renderer.render(
      <OpportunityPageContent id="1234" />
    );
    ...
    expect(console.warn.calls[0].args[0]).toBe(
      ...
      '` was not specified in `OpportunityPageContent`.'
    );
  });
